...
class GateNet(Network):
    ...
    def setup(self):
        ...
        base_filter = 8
        (self.feed('data')
        .conv_bn(3, base_filter * 2, 2, center=True, scale=True, name='gateconv1_0')#/2
        .conv_bn(3, base_filter * 4, 2, center=True, scale=True, name='gateconv2_0')#/4
        .conv_bn(3, base_filter * 8, 2, center=True, scale=True, name='gateconv3_0'))#/8

        (self.feed('data')
        .conv_bn(3, base_filter, 1, center=True, scale=True, name='gateconv0_1'))

        (self.feed('gateconv1_0')
        .conv_bn(3, base_filter * 2, 1, center=True, scale=True, name='gateconv1_1'))#/2

        (self.feed('gateconv2_0')
        .conv_bn(3, base_filter * 4, 1, center=True, scale=True, name='gateconv2_1'))#/4

        (self.feed('gateconv3_0')
        .conv_bn(3, base_filter * 8, 1, center=True, scale=True, name='gateconv3_1')
        .deconv_bn(3, base_filter * 4, 2, center=True, scale=True, name='gateconv4_0'))#/4

        (self.feed('gateconv4_0', 'gateconv2_1')
        .add(name='gateconv4_1')
        .deconv_bn(3, base_filter * 2, 2, center=True, scale=True, name='gateconv5_0'))

        (self.feed('gateconv5_0', 'gateconv1_1')
        .add(name='gateconv5_1')
        .deconv_bn(3, base_filter*1, 2, center=True, scale=True, name='gateconv6_0'))
...
class OutputNet(Network):
    ...
    def setup(self):
        ...
        base_filter = 8
        (self.feed('data')
        .conv_bn(3, base_filter * 2, 2, center=True, scale=True, name='outputconv1_0')#/2
        .conv_bn(3, base_filter * 4, 2, center=True, scale=True, name='outputconv2_0')#/4
        .conv_bn(3, base_filter * 8, 2, center=True, scale=True, name='outputconv3_0'))#/8

        (self.feed('data')
        .conv_bn(3, base_filter, 1, center=True, scale=True, name='outputconv0_1'))

        (self.feed('outputconv1_0')
        .conv_bn(3, base_filter * 2, 1, center=True, scale=True, name='outputconv1_1'))#/2

        (self.feed('outputconv2_0')
        .conv_bn(3, base_filter * 4, 1, center=True, scale=True, name='outputconv2_1'))#/4

        (self.feed('outputconv3_0')
        .conv_bn(3, base_filter * 8, 1, center=True, scale=True, name='outputconv3_1')
        .deconv_bn(3, base_filter * 4, 2, center=True, scale=True, name='outputconv4_0'))#/4

        (self.feed('outputconv4_0', 'outputconv2_1')
        .add(name='outputconv4_1')
        .deconv_bn(3, base_filter *2, 2, center=True, scale=True, name='outputconv5_0'))

        (self.feed('outputconv5_0', 'outputconv1_1')
        .add(name='outputconv5_1')
        .deconv_bn(3, base_filter*1, 2, center=True, scale=True, name='outputconv6_0'))
